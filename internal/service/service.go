...
func NewConduitService(gc *biz.GroupUseCase, gt *biz.GateWayUsecase, pc *biz.ProfileUsecase, mc *biz.MessageUseCase, chatUC *chat.ChatUsecase, logger log.Logger) *ConduitService {
